...
def indicizza_file(testo, nome_file, file_id):
    ...
    # path completo destinazione
    dest_cartella = os.path.join(NAS_PATH, cartella)

    # crea la cartella se non esiste
    os.makedirs(dest_cartella, exist_ok=True)

    # sposta il file
    src = os.path.join(NAS_PATH, nome_file)
    dest = os.path.join(dest_cartella, nome_file)
    os.rename(src, dest)

    print(f"  ✓ File spostato in: {dest}")
...
if __name__ == "__main__":
    ...
    cartella_input = "/Users/riccardoinfascelli/Desktop/Hackathon/PROVA"
    ...
    indicizza_file(testo, nome_file, "file_001")